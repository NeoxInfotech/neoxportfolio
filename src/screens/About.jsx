...
const About = () => {
    return (
        <div className='min-h-[90vh] bg-[#F0E9D8] flex flex-col md:flex-row '>
            <div className="left w-[100%] md:w-[50%] flex items-center justify-center">
                <img src={aboutbg} alt="" className='h-[80%]' />
            </div>
            <div className="right w-[100%] md:w-[50%] flex flex-col items-center justify-center gap-6 py-6">
